...
- `docs/troubleshooting.md` describes `GTR_DEBUG`.
...
- `AGENTS.md` and `CLAUDE.md` attributed `postCd` hooks to `run_hooks_in`; they now describe `run_hooks_export` and the `init`-generated shell functions.
