...
**Registry-defined adapters**: vscode, cursor, idea, vim, nvim, pycharm, sublime, zed, webstorm, antigravity, emacs, atom (editors) and copilot, codex, gemini, opencode, aider, continue, auggie (AI).
